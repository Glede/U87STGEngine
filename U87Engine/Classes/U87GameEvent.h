...
namespace u87
{
    ...
    const EventType _EVT_NONE = (unsigned int)-1;
#define EVT_NONE _EVT_NONE
...
#define EVENTTYPE_FUNC(type)  virtual u87::EventType getEventType() const { return type; }
    ...
    const EventType EVT_COLLISION = (unsigned int)-2;
    // basic event is a collision between two body nodes
    // defination in U87Collision.h
